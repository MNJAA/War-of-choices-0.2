...
#story choices that will be shoed to the user and will determine what should be printed next
	"choices": {
		"chapter1c":{"surround": "Captain, maybe we should consider surrendering, there might be a chance for peace and our safety.",

					"fight": "Captain, I say we fight back, We can't afford to be caught off guard."
		},
